...
export default function Hero() {
    return (
        <motion.section
            ...
            className="relative w-full min-h-screen flex items-center justify-center bg-transparent dark:bg-transparent px-4 transition-colors duration-300 overflow-hidden"
        ...
        >
            ...
            >
                ...
                <p className="mt-6 text-lg md:text-xl lg:text-2xl text-gray-700 dark:text-gray-200 max-w-3xl mx-auto">
                    Hi, I'm Mohd Arbaz 👋 Full Stack Developer | Software
                    Engineer | BCA Student I build modern and scalable web
                    applications using the MERN stack. Currently working on many
                    projects and open to internship opportunities 🚀
                </p>
            </motion.div>
        </motion.section>
    );
